...
class CommunicationsControllerTest < ActionController::TestCase
  ...
  test "should create communication" do
    assert_difference('Communication.count') do
      post :create, communication: { about: @communication.about, keyword: @communication.keyword, person_id: @communication.person_id, subject_id: @communication.subject_id, user_id: @communication.user_id }
    end
  ...
  test "should update communication" do
    patch :update, id: @communication, communication: { about: @communication.about, keyword: @communication.keyword, person_id: @communication.person_id, subject_id: @communication.subject_id, user_id: @communication.user_id }
    assert_redirected_to communication_path(assigns(:communication))
  end
