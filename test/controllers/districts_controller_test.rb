...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { country: @district.country, county: @district.county, name: @district.name, note: @district.note }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { country: @district.country, county: @district.county, name: @district.name, note: @district.note }
    assert_redirected_to district_path(assigns(:district))
  end
